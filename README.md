...
- [x] Orbit control을 전체 화면에서 활용해야 한다. _2022.05.16_
- [x] Box geometry에 불필요한 wireframe 제거 필요 _2022.05.16_
- [x] PLY 파일을 GLB 파일로 바꾸고 업로드 하기 _2022.05.17_
...
- [x] Navigation 과 Canvas 독립의 문제 _2022.05.17_
...
- [x] Realtime으로 입력된 소원이 출력될 수 있는 페이지 레이아웃 구성 _2022.06.04_
- [x] Multihover state 를 Recoil을 활용해서 전역으로 사용할 수 있는 state로 변경 _2022.06.04_
